 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.boilerplate.staging
 */

const BUNDLE_ID = 'com.boilerplate'; // ios bundle id
const PACKAGE = 'com.boilerplate'; // android package name
const NAME = 'Expo-Starter-Kit'; // app name
const EXPO_ACCOUNT_OWNER = 'linnify'; // expo account owner
